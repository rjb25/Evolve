...
class Peasant:
    def __init__(self,**kwargs):
        self.health = 100
        self.goods = 10
        self.offense = random.randint(1, 5)
        self.fights = random.randint(1, 10)
        self.cut = random.random()
        self.tax = random.randint(1, 10)
        self.tolerate = random.randint(1, 10)
        self.options = ["rob","job"]
    ...
    def __str__(self):
        #Need a print tool
        return str(self.id) + " " + self.name + " Health:" + str(self.health) + " Goods:" + str(self.goods) + " Do:" + self.action + " " + str(self.last_target) + " tax" + str(self.tax) + " tol" +str(self.tolerate) + " cut" + str(round(self.cut,2))
